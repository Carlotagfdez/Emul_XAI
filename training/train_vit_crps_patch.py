...
train_loss, val_loss = deep4downscaling.deep.train.standard_training_loop(
    ...
    mixed_precision=False, tracker=tracker)
...
# Compute predictions (ensemble of 10 members)
