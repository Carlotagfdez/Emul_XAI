...
y_train_stack_filt = y_train_stack.where(
    y_train_stack['gridpoint'] == y_mask_stack_filt['gridpoint'], drop=True)
...
# Set model name
model_name = 'deepesd_ASYM'

# Create model
model = deep4downscaling.deep.models.DeepESD(x_shape=x_train_stand_arr.shape,
...
# Load and prepare ASYM parameters
loss_function.load_parameters()
loss_function.mask_parameters(y_mask)
